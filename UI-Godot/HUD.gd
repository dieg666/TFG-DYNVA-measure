...
func change_to_mode(encoded_mode):
	...
	$PanelContainer/HBoxContainer/VBoxContainer/VBoxContainer/HBoxContainer3/Label2.text = str(log($PanelContainer/HBoxContainer/VBoxContainer/VBoxContainer/HBoxContainer3/SpinBox.value *60)/log(10)) + " logMar"
...
func _on_SpinBox_text_changed(new_text):
	$PanelContainer/HBoxContainer/VBoxContainer/VBoxContainer/HBoxContainer3/Label2.text = str(log($PanelContainer/HBoxContainer/VBoxContainer/VBoxContainer/HBoxContainer3/SpinBox.value *60)/log(10)) + " logMar"
	pass # Replace with function body.
